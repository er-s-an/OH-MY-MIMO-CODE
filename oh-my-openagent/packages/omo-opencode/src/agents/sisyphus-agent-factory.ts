...
import { buildMimoSisyphusPrompt } from "./sisyphus/mimo"
...
export function createSisyphusAgent(
  ...
  if (isMimocodeRuntime()) {
    return buildMimoSisyphusAgentConfig(
      MODE,
      model,
      buildMimoSisyphusPrompt(),
    )
  }
