...
最省事的方式：把这个仓库的 GitHub 链接发给 MiMo Code，并让它按 [prompts/setup-with-mimo-code.md](prompts/setup-with-mimo-code.md) 安装 OMM。现在已经是 agent 的年代了，不会真的有人给 agent 安装插件还是自己安装吧？
